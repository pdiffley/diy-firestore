...
<Image src="/images/collection-dark.png" alt="drawing" height="30" width="30" /> users
...
​ `user_name : 'morgan'` ​ `age: 35` ​ `city: Memphis` ​ `zipcode: 38125`
...
​ `user_name: alex` ​ `age: 20` ​ `city: Memphis` ​ `zipcode: 38125`
