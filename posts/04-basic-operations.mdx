...
but we will be expanding them over the course of this series so that
...
so our `write_document` function can just delete the old document and create a new one.
