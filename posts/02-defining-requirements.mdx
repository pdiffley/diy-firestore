...
how Firestore works at all, it could be helpful to read the {/_Firestore's
docs_/} which explain Firestore's features in more detail.
...
<Image src="/images/document-dark.png" alt="drawing" height="30" width="30" />
roomA
...
<Image src="/images/collection-dark.png" alt="drawing" height="30" width="30" />
messages
...
{/_Todo: Note that in a production app we might want to integrate the rust code
into database functions through a c interface to avoid making multiple round
trips between our server and database_/}
