...
<div className="collection">
  <div className="document-title"> <Image src="/images/collection-dark.png" alt="drawing" height="30" width="30" /> <div className="document-name"> messages </div> </div>
  <div className="collections-tabbed">
    <div className="document-title"><Image src="/images/document-dark.png" alt="drawing" height="30" width="30" /> <div className="document-name"> message1 </div> </div>
  ...
  <div className="collections-tabbed">
    <div className="document-title"><Image src="/images/document-dark.png" alt="drawing" height="30" width="30" /> <div className="document-name"> message2 </div> </div>
