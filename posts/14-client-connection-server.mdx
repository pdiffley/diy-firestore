...
<Image src="/images/diy-firestore-system-design.svg" alt="system diagram with boxes for clients, database server, RabbitMQ, and long poll server" height="600" width="600" />
