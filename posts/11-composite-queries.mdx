...
we tried support all possible composite queries, we would quickly run into a
...
first field, the **primary field**, can be queried with inequality operators (`<`,
...
belongs to. Our composite queries need to be generated dynamically so I have
